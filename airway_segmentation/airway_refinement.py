    ...
    def _estimate_adaptive_thresholds(self):
        ...
        try:
            ...
            if len(thresholds) >= 2:
                ...
                intermediate_threshold = min(t1 + 100, -550)
                peripheral_threshold = min(t1 + 120, -400)
            ...
            central_threshold = -900
            intermediate_threshold = -700
            peripheral_threshold = -500
